#!/usr/bin/env python3
"""
Intent Classifier Training Script (RoBERTa)
-------------------------------------------
Trains an intent classifier on TREC, SQuAD, and SciQ datasets using RoBERTa-base.

This script:
1. Loads TREC, SQuAD, and SciQ datasets using Hugging Face datasets
2. Preprocesses the data for intent classification
3. Trains a RoBERTa-based transformer classifier
...
def train_intent_classifier(
    ...
    output_dir='./intent_classifier_model_roberta',
    num_epochs=3,
    batch_size=16,
    learning_rate=2e-5,
    ...
    print("=" * 60)
    print("Intent Classifier Training (RoBERTa-base)")
    print("=" * 60)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Train intent classifier on TREC, SQuAD, and SciQ datasets using RoBERTa')
    parser.add_argument('--model', type=str, default='roberta-base',
                        help='Model name or path (default: roberta-base)')
    parser.add_argument('--output_dir', type=str, default='./intent_classifier_model_roberta',
                        help='Output directory for the model (default: ./intent_classifier_model_roberta)')
